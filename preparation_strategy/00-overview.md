...
| 12 | [**back-of-envelope-sizing.md**](back-of-envelope-calculations.md), [**back-of-envelope-calculations.md**](back-of-envelope-calculations.md) | **Sizing cheat sheet:** RPS → requests/day → storage/day @ 1 KiB → rough server count; DAU chains; peak multipliers. **Calculations** file points here (alias if you bookmark that name). |
