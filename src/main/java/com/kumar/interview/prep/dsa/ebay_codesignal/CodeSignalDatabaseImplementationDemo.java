 ...
 *
 * Level 1: set, get, compareAndSet, compareAndDelete
 * Level 2: scan, scanByPrefix  -> returns field(value), sorted by field
 * Level 3: setWithTTL, compareAndSetWithTTL; expired fields treated as absent
 * Level 4: getWhen -> value valid at a historical timestamp (respects TTL)
 *
